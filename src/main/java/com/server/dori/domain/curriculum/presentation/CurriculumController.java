...
public class CurriculumController {
	...
	@PostMapping("/survey")
	public ResponseEntity<CustomApiResponse<CurriculumSurveyResponse>> saveSurvey(@RequestBody CurriculumSurveyRequest request, @AuthenticationPrincipal CustomUserDetails userDetails) {
