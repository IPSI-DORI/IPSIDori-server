...
public enum CharacterType {
	...
	CharacterType(String name, String description, int minScore, int maxScore, String imagePrefix,
	...
	public String getImageUrl(String baseUrl) {
		return String.format("%s/%s.png", baseUrl, this.imagePrefix);
	}
